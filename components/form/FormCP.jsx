...
const FormCP = ({ formClose, setFormClose }) => {
  return (
    <button
      ...
      className="exclude-print fixed bottom-5 left-10 font-bold rounded-full bg-white text-blue-600 shadow-lg border-2 border-white hover:bg-blue-50 transition-colors duration-200"
